...
print  "\n\nPrinting number of low budget tourists in the given city\n\n", lb_final,"\n\nPrinting number of low budget tourists in the given city\n\n", hb_final
#print monthly,
for i in avg2.keys():
    avg2[i] = sum(avg2[i])/len(avg2[i])
    
print "\n\nPrinting average number of days spent per city\n\n", avg2
...
print "\n\nPrinting number of visits per city in a given MONTH\n\n"
print monthly
